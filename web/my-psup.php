	...
	<section id="work">
		...
		<div class="content">
			<p class="small">
				<span class="icon-sphere"></span> <a href="http://www.mypsup.org" target="_blank">mypsup.org</a><br/>
				Zinnebeeld project
			</p>
			<p>
				PSUP is a United Nations programme aimed at improving the lives of slum dwellers worldwide. In cooperation with <a href="http://www.welovethecity.eu/en/home" target="_blank">We Love The City</a> Zinnebeeld has developed a discussion platform and E-Learning tools to empower local experts and improve collaboration.
			</p>
			<p>
				For the PSUP project my tasks included conducting research into E-Learning environments, design and development of the E-Learning tool. 
			</p>
	</section>
